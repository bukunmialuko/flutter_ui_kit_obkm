...
import 'package:flutter_ui_kit_obkm/src/screens/23/widget/schedule_list.dart';
...
class _DateItem extends StatelessWidget {
  ...
  const _DateItem({required this.isToday, required this.day, required this.dayNumber});
